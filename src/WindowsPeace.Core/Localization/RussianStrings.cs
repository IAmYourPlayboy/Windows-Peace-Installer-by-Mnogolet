...
public sealed class RussianStrings : ILanguagePack
{
    ...
    public IReadOnlyDictionary<string, string> Strings { get; } = new Dictionary<string, string>
    {
        ...
        [Keys.Disk.ErrorTimeout] = "Опрос дисков превысил отведённое время",
        [Keys.Disk.ErrorForbidden] = "Недостаточно прав для опроса дисков",
        [Keys.Disk.ErrorFailed] = "Опрос дисков сорвался: {0}",
        [Keys.Disk.NotYetSoon] = "Эта операция появится на следующем шаге.",
        [Keys.Disk.NotYetNoWrite] = "Сейчас программа ничего не записывает на диск.",
