...
public sealed class EnglishStrings : ILanguagePack
{
    ...
    public IReadOnlyDictionary<string, string> Strings { get; } = new Dictionary<string, string>
    {
        ...
        [Keys.Disk.ErrorTimeout] = "Disk scan exceeded the time allowed",
        [Keys.Disk.ErrorForbidden] = "Not enough permissions to scan disks",
        [Keys.Disk.ErrorFailed] = "Disk scan failed: {0}",
        [Keys.Disk.NotYetSoon] = "This operation will appear in the next step.",
        [Keys.Disk.NotYetNoWrite] = "For now the program writes nothing to disk.",
